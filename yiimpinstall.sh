...
##############################################################################
# Original Authors:   crombiecrunch manfromafar Xavatar
# Current Galahash - Havoc3
# # Program:
#   Install Galahash(yiimp) on Ubuntu 16.04 running Nginx, MariaDB, and php7.x
#
################################################################################
output() {
    printf "\E[0;33;40m"
...
#    if [[ ("$UFW" == "y" || "$UFW" == "Y" || "$UFW" == "") ]]; then
    ...
    sudo ufw allow 5666 #this is for 1&1 monitoring agent
...
sudo mv $HOME/Galahash/ $HOME/Galahash-install-src
sudo service nginx restart
sudo service php7.0-fpm reload
